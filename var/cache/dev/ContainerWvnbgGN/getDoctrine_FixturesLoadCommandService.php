...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\FigureFixture.php';
...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\VideoFixture.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CommentFixture(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\FigureFixture(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\PostFixture(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixture(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\VideoFixture(), 'groups' => []]]);
