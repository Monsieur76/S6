...
// Returns the private 'App\Repository\FigureRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FigureRepository.php';

return $this->privates['App\\Repository\\FigureRepository'] = new \App\Repository\FigureRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->load('getDoctrine_Orm_DefaultEntityManagerService.php')));
