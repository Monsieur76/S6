...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'index' => [[], ['_controller' => 'App\\Controller\\FigureController::index'], [], [['text', '/']], [], []],
        'figure' => [['id'], ['_controller' => 'App\\Controller\\FigureController::figure'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/figure']], [], []],
        'updateFigure' => [['id'], ['_controller' => 'App\\Controller\\FigureController::updateFigure'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/updateFigure']], [], []],
        'creatFigure' => [[], ['_controller' => 'App\\Controller\\FigureController::creatFigure'], [], [['text', '/creatFigure']], [], []],
        'deleteFigure' => [['id'], ['_controller' => 'App\\Controller\\FigureController::deleteFigure'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/deleteFigure']], [], []],
        'deleteImgFigure' => [['id'], ['_controller' => 'App\\Controller\\FigureController::deleteImgFigure'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/deleteImgFigure']], [], []],
        'updateImg' => [['id'], ['_controller' => 'App\\Controller\\ImgController::updateImg'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/updateImg']], [], []],
        'deleteImg' => [['id'], ['_controller' => 'App\\Controller\\ImgController::deleteImg'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/deleteImg']], [], []],
