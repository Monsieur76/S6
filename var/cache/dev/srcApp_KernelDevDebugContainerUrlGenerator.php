...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'home' => [[], ['_controller' => 'App\\Controller\\FigureController::home'], [], [['text', '/']], [], []],
        'figure' => [['id'], ['_controller' => 'App\\Controller\\FigureController::post'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/figure']], [], []],
        'updateFigure' => [['id'], ['_controller' => 'App\\Controller\\FigureController::updatePost'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/updateFigure']], [], []],
