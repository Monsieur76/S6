 ...
 */
final class Version20190718155129 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE img (id INT AUTO_INCREMENT NOT NULL, figure_id INT DEFAULT NULL, name_img VARCHAR(255) NOT NULL, INDEX IDX_BBC2C8AC5C011B5 (figure_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE img ADD CONSTRAINT FK_BBC2C8AC5C011B5 FOREIGN KEY (figure_id) REFERENCES figure (id)');
